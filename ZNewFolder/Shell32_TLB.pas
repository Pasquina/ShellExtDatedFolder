...
// $Rev: 98336 $
// File generated on 1/4/2021 4:29:01 PM from Type Library described below.
...
// *********************************************************************//
  IShellFolderViewDual = interface(IDispatch)
    ...
    procedure SelectItem(const pvfi: OleVariant; dwFlags: SYSINT); safecall;
...
// *********************************************************************//
  IShellFolderViewDualDisp = dispinterface
    ...
    procedure SelectItem(const pvfi: OleVariant; dwFlags: SYSINT); dispid 1610743813;
...
// *********************************************************************//
  IFileSearchBand = interface(IDispatch)
    ...
    procedure SetSearchParameters(var pbstrSearchID: WideString; bNavToResults: WordBool; 
                                  const pvarScope: OleVariant; const pvarQueryFile: OleVariant); safecall;
...
// *********************************************************************//
  IFileSearchBandDisp = dispinterface
    ...
    procedure SetSearchParameters(var pbstrSearchID: WideString; bNavToResults: WordBool; 
                                  const pvarScope: OleVariant; const pvarQueryFile: OleVariant); dispid 2;
...
// *********************************************************************//
  IWebWizardHost = interface(IDispatch)
    ...
    procedure Set_Property_(const bstrPropertyName: WideString; const pvProperty: OleVariant); safecall;
...
// *********************************************************************//
  IWebWizardHostDisp = dispinterface
    ...
    function Property_(const bstrPropertyName: WideString): {NOT_OLEAUTO(POleVariant1)}OleVariant; dispid 4;
